...
class Ui_PlotWindow(object):
    def setupUi(self, PlotWindow):
        ...
        self.actionOpen_csv_file = QtWidgets.QAction(PlotWindow)
    ...
    def retranslateUi(self, PlotWindow):
        ...
        PlotWindow.setWindowTitle(_translate("PlotWindow", "PyShine simple plot"))
        self.label.setText(_translate("PlotWindow", "Select Theme"))
        self.pushButton.setText(_translate("PlotWindow", "Open"))
        self.menuFile.setTitle(_translate("PlotWindow", "File"))
        self.actionOpen_csv_file.setText(_translate("PlotWindow", "Open csv file"))
